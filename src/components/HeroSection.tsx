...
function HeroSection() {
  return (
   ...
   <div className='flex flex-col justify-center items-center h-screen'>
       <div>
       <h1  className='bg-clip-text text-transparent bg-gradient-to-r from-gray-100 via-gray-300 to-gray-500 text-center text-3xl lg:text-7xl font-bold'>Ark Impact Founders <br /><span className='bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500'>Fellowship</span><span className='text-white'>.</span></h1>
       </div>
