  ...
  return (
    <AuroraBackground>
      ...
      >
       ...
       <div>
       <h1  className='bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-white via-gray-300 to-gray-500 text-center text-3xl lg:text-7xl font-bold'>Ark Impact Founders <br /><span className='bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500'>Fellowship</span><span className='text-white'>.</span></h1>
       </div>
